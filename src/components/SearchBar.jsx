  ...
  return (
    <div className="mx-6 flex w-1/2 flex-shrink-0 h-full ">
      <div className="input-group relative flex flex-nowrap w-full ">
        ...
        />
        <button
          className="mx-1 btn inline-block px-6 bg-gray-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-800  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out items-center"
          type="button"
          id="button-addon2"
